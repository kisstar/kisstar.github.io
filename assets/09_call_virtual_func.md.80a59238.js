import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.e9126b17.js";const u=JSON.parse('{"title":"绝不在构造和析构过程中调用虚函数","description":"","frontmatter":{},"headers":[],"relativePath":"09/call/virtual/func.md","filePath":"effective-cpp/09-call-virtual-func.md","lastUpdated":1710654063000}'),p={name:"09/call/virtual/func.md"},o=l(`<h1 id="绝不在构造和析构过程中调用虚函数" tabindex="-1">绝不在构造和析构过程中调用虚函数 <a class="header-anchor" href="#绝不在构造和析构过程中调用虚函数" aria-label="Permalink to &quot;绝不在构造和析构过程中调用虚函数&quot;">​</a></h1><p>不要在构造函数和析构函数期间调用 virtual 函数，因为这样的调用不会带来你预想的结果，就算有你也不会高兴。</p><div class="language-cpp vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">cpp</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">class</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">Transaction</span></span>
